...
public class JwtUtil {
    ...
    public static String createJWT(String secretKey, long ttlMillis, Map<String, Object> claims) {
        ...
        String jws = Jwts.builder()
                .subject("LoginToken")
                .claims(claims)
                .expiration(new Date(System.currentTimeMillis() + ttlMillis)) //two hours
                .signWith(key, algo)
                .compact();
        return jws;
    }
    ...
    public static Claims parseJWT(String secretKey, String token){
        ...
        Claims parsed = Jwts.parser()
                ...
                .build()
                .parseSignedClaims(token)   // parse a signed (JWS) token
                .getPayload();
        return parsed;
    }
    ...
    @Deprecated
    public static String createJWT_Old(String secretKey, long ttlMillis, Map<String, Object> claims) {
